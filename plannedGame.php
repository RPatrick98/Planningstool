        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-left border ">
                    ...
                    <div class="border-bottom">
                        <strong>Expansions: <?=$plan["explains_person"]?></strong>
                    </div>
                    <div class="border-bottom">
                        <strong>Players: <?=$plan["count_players"]?></strong>
                    </div>

                    <div class="border-bottom">
                        <strong>Date and time: <?=$plan["planned_time"]?></strong>
                    </div>
